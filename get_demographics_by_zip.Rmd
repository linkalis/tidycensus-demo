...
```{r}
filter_data <- all_vars %>% filter(GEOID %in% preview_zips)

ggplot(all_vars_wide, aes(fill = estimate)) + 
  geom_sf(color = NA) + 
  coord_sf(crs = 32615) + 
